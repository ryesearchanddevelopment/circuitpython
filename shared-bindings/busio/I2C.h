...
extern mp_errno_t common_hal_busio_i2c_write(busio_i2c_obj_t *self, uint16_t address,
...
extern mp_errno_t common_hal_busio_i2c_read(busio_i2c_obj_t *self, uint16_t address,
    uint8_t *data, size_t len);

// Do a write and then a read in the same I2C transaction.
mp_errno_t common_hal_busio_i2c_write_read(busio_i2c_obj_t *self, uint16_t address,
